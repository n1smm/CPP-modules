...
/*   Updated: 2024/12/13 14:55:37 by tjuvan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* constructors */
ClapTrap::ClapTrap() : _name("clapy"), _hit_points(10), _energy_points(10), _attack_dmg(0) { std::cout << "ClapTrap\n"; }
ClapTrap::ClapTrap( std::string name ) : _name(name), _hit_points(10), _energy_points(10), _attack_dmg(0) {  std::cout << "ClapTrap\n"; }
ClapTrap::ClapTrap( const ClapTrap &copy) : _name(copy.getName()), _hit_points(copy.getHitPoints()),
	_energy_points(copy.getEnergyPoints()), _attack_dmg(copy.getAttackDmg()) {  std::cout << "ClapTrap\n"; }
ClapTrap::~ClapTrap() { std::cout << _name << " ClapTrap dead\n"; }
